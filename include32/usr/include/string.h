...
extern size_t REF(&& [V >= 0; (BLOCK_END([__s]) - __s) >= V + 1])
    strlen (__const char NULLTERMSTR FINAL * STRINGPTR __s)
     __THROW __attribute_pure__ __nonnull ((1)) OKEXTERN;
__END_NAMESPACE_STD
...
extern char NULLTERMSTR * STRINGPTR strerror (int __errnum) __THROW OKEXTERN;
__END_NAMESPACE_STD
