...
extern unsigned long int strtoul (__const char * NNSTRINGPTR __restrict __nptr,
				  char **__restrict __endptr, int __base)
     __THROW __nonnull ((1)) __wur OKEXTERN;
__END_NAMESPACE_STD
...
extern long int random (void) __THROW OKEXTERN;
...
extern int atexit (void (* NONNULL __func) (void)) __THROW __nonnull ((1)) OKEXTERN;
...
// CSOLVE
extern void REF(0 = 1) exit (int __status) __THROW __attribute__ ((__noreturn__)) OKEXTERN;
...
extern char * LOC(CSOLVE_GLOBALENV) NNSTRINGPTR getenv (__const char * STRINGPTR __name) __THROW __nonnull ((1)) __wur GLOBAL(CSOLVE_GLOBALENV) OKEXTERN;

extern char * LOC(CSOLVE_GLOBALENV) NNSTRINGPTR csolve_global_env;
